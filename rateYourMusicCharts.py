...
class rateYourMusicCharts:
    def __init__(self):
        ...
        ######### Singles - WorstYearly #########
        self.chartRanks[52] = ['c_Worst_singles_of_1950', 'c_Worst_singles_of_1951', 'c_Worst_singles_of_1952', 'c_Worst_singles_of_1953', 'c_Worst_singles_of_1954']
        self.chartRanks[53] = ['c_Worst_singles_of_1955', 'c_Worst_singles_of_1956', 'c_Worst_singles_of_1957', 'c_Worst_singles_of_1958', 'c_Worst_singles_of_1959']
        self.chartRanks[54] = ['c_Worst_singles_of_1960', 'c_Worst_singles_of_1961', 'c_Worst_singles_of_1962', 'c_Worst_singles_of_1963', 'c_Worst_singles_of_1964']
        self.chartRanks[55] = ['c_Worst_singles_of_1965', 'c_Worst_singles_of_1966', 'c_Worst_singles_of_1967', 'c_Worst_singles_of_1968', 'c_Worst_singles_of_1969']
        self.chartRanks[56] = ['c_Worst_singles_of_1970', 'c_Worst_singles_of_1971', 'c_Worst_singles_of_1972', 'c_Worst_singles_of_1973', 'c_Worst_singles_of_1974']
        self.chartRanks[57] = ['c_Worst_singles_of_1975', 'c_Worst_singles_of_1976', 'c_Worst_singles_of_1977', 'c_Worst_singles_of_1978', 'c_Worst_singles_of_1979']
        self.chartRanks[58] = ['c_Worst_singles_of_1980', 'c_Worst_singles_of_1981', 'c_Worst_singles_of_1982', 'c_Worst_singles_of_1983', 'c_Worst_singles_of_1984']
        self.chartRanks[59] = ['c_Worst_singles_of_1985', 'c_Worst_singles_of_1986', 'c_Worst_singles_of_1987', 'c_Worst_singles_of_1988', 'c_Worst_singles_of_1989']
        self.chartRanks[60] = ['c_Worst_singles_of_1990', 'c_Worst_singles_of_1991', 'c_Worst_singles_of_1992', 'c_Worst_singles_of_1993', 'c_Worst_singles_of_1994']
        self.chartRanks[61] = ['c_Worst_singles_of_1995', 'c_Worst_singles_of_1996', 'c_Worst_singles_of_1997', 'c_Worst_singles_of_1998', 'c_Worst_singles_of_1999']
        self.chartRanks[62] = ['c_Worst_singles_of_2000', 'c_Worst_singles_of_2001', 'c_Worst_singles_of_2002', 'c_Worst_singles_of_2003', 'c_Worst_singles_of_2004']
        self.chartRanks[63] = ['c_Worst_singles_of_2005', 'c_Worst_singles_of_2006', 'c_Worst_singles_of_2007', 'c_Worst_singles_of_2008', 'c_Worst_singles_of_2009']
        self.chartRanks[64] = ['c_Worst_singles_of_2010', 'c_Worst_singles_of_2011', 'c_Worst_singles_of_2012', 'c_Worst_singles_of_2013', 'c_Worst_singles_of_2014']
        self.chartRanks[65] = ['c_Worst_singles_of_2015', 'c_Worst_singles_of_2016', 'c_Worst_singles_of_2017', 'c_Worst_singles_of_2018', 'c_Worst_singles_of_2019']
        self.chartRanks[66] = ['c_Worst_singles_of_2020']
        ######### Titles #########
        self.chartRanks[67] = ['c_1000_Great_Albums', 'c_1001_Albums_You_Must_Hear', 'c_1001_Albums_You_Must_Hear_Before_You_Die', 'c_100_Best_Swedish_Albums', 'c_100_Favourite_Songs_of_All_Time', 'c_1500_Songs_From_Under_The_Floorboards']
        self.chartRanks[68] = ['c_200_Russian_Albums', 'c_3500_Albums_You_Gotta_Listen_To', 'c_3_Favorite_Albums_of_each_year', 'c_500_Most_Depressing_Songs_I_Ever_Heard', 'c_50_Greatest_Hawaii_Albums_of_All_Time', 'c_953_of_My_Favorite_Albums_A_Z']
        self.chartRanks[69] = ['c_ALL_JAPAN_The_Greatest_JPN_Albums', 'c_Africa_Albums', 'c_Albums_from_Benelux', 'c_Albums_from_Canada', 'c_Albums_from_Eastern_Europe', 'c_Albums_from_France']
        self.chartRanks[70] = ['c_Albums_from_Germany', 'c_Albums_from_Ireland', 'c_Albums_from_Italy', 'c_Albums_from_Landlocked_Europe', 'c_Albums_from_Oceania', 'c_Albums_from_Quebec']
        self.chartRanks[71] = ['c_Albums_from_Scandinavia', 'c_Albums_from_Scotland', 'c_Albums_from_Wales', 'c_Albums_from_the_Caribbean', 'c_Albums_from_the_Far_East', 'c_Albums_from_the_Iberian_Peninsula']
        self.chartRanks[72] = ['c_Albums_from_the_Spanish_Americas', 'c_Amazingly_Awful_Album_Art', 'c_Awful_Ass_Album_Covers', 'c_Best_360_R_B_Albums', 'c_Best_Albums_Of_All_Time', 'c_Best_Albums_of_Reggaeton_of_All_Time']
        self.chartRanks[73] = ['c_Blood_Pumps_1500_Favorite_Albums', 'c_Favorite_Albums_2010_2019', 'c_Favorite_Anthologies_Albums', 'c_Favorite_Chinese_Albums', 'c_Favorite_Danish_Albums', 'c_Favorite_Pop_Albums']
        self.chartRanks[74] = ['c_Favorite_Russian_Albums', 'c_Foreign_Language_Albums_in_the_RYM_all_time', 'c_Forever_Young_2500_Best_Songs', 'c_Funk_Albums_from_the_United_States_and_England', 'c_Good_Ass_Album_Covers', 'c_Grammy_Album_of_the_Year']
        self.chartRanks[75] = ['c_Hip_Hop_Greatest_Albums_of_All_Time', 'c_Japanese_Albums_That_I_Like', 'c_My_300_Favourite_Albums_Ranked', 'c_My_300_favorite_Albums', 'c_My_Top_1000_Favorite_Hip_Hop_Albums', 'c_My_Top_100_Swedish_Albums']
        self.chartRanks[76] = ['c_My_Top_500_Songs_of_All_Time', 'c_My_favorite_Album_Covers_of_SIX_different_types', 'c_Personal_250_Korean_Albums', 'c_Ranking_Albums_of_2016', 'c_Rolling_Stone_Japans_100_Greatest_Japanese_Rock_Albums_of_All_Time', 'c_Serpentine_Gallery_50_Of_The_Very_Best_Post_Punk_Albums']
        self.chartRanks[77] = ['c_Short_Dogs_In_The_House_The_Shortest_Albums_Ever', 'c_Song_of_the_day', 'c_Strongest_Chinese_Albums_in_History', 'c_The_Best_500_Albums_Of_The_20th_Century', 'c_The_Best_Album_in_Every_Genre_Ive_Heard', 'c_The_Top_100_Albums_of_1980s']
        self.chartRanks[78] = ['c_These_1_840_K_Pop_Albums_Are_the_Best_Maybe', 'c_Top_100_Alt_Country_Albums_of_All_Time', 'c_Top_100_Favorite_Hip_Hop_Albums_of_All_Time', 'c_Top_100_Japanese_Albums', 'c_Top_250_Reggae_Albums_According_to_RYMs_Heavy_Reggae_Heads_', 'c_Top_500_Best_Albums_Ever_Made']
        self.chartRanks[79] = ['c_Top_501_Favorite_Albums', 'c_Ultimate_Songs_of_1990', 'c_XPNs_2014_885_Best_Songs_of_All_Time', 'c_XPNs_2014_88_Worst_Songs_Of_All_Time']
        ######### Artists #########
        self.chartRanks[80] = ['c_200_Greatest_Rock_Artists_of_All_Time', 'c_An_Artist_from_Every_Region', 'c_Danish_Artists', 'c_Great_Belgian_Artists', 'c_Hip_Hop_Artists_for_Me_to_Check_Out', 'c_Top_200_Worst_Artists_v2']
        self.chartRanks[81] = ['c_Top_Artists_Chart']
        ######### Script #########
        self.chartRanks[82] = ['c_Artists_Releases_with_Gujarati_script', 'c_Artists_Releases_with_Gurmukhi_script']
        self.chartRanks[83] = ['c_Artists_Releases_with_Kannada_script', 'c_Artists_Releases_with_Khmer_script']
        self.chartRanks[84] = ['c_Artists_Releases_with_Lao_script', 'c_Artists_Releases_with_Malayalam_script']
        self.chartRanks[85] = ['c_Artists_Releases_with_NKo_script', 'c_Artists_Releases_with_Oriya_script']
        self.chartRanks[86] = ['c_Artists_Releases_with_Syriac_script', 'c_Artists_Releases_with_Telugu_script']
        self.chartRanks[87] = ['c_Artists_Releases_with_Tibetan_script', 'c_Artists_Releases_with_Tifinagh_script']
        self.chartRanks[88] = ['c_Artists_with_Arabic_script', 'c_Artists_with_Armenian_script']
        self.chartRanks[89] = ['c_Artists_with_Bengali_script', 'c_Artists_with_Burmese_script']
        self.chartRanks[90] = ['c_Artists_with_Devanagari_script', 'c_Artists_with_Geez_script']
        self.chartRanks[91] = ['c_Artists_with_Greek_script', 'c_Artists_with_Hangul_script']
        self.chartRanks[92] = ['c_Artists_with_Hebrew_script', 'c_Artists_with_Sinhala_script']
        self.chartRanks[93] = ['c_Artists_with_Tamil_script', 'c_Artists_with_Thai_script']
        ######### Other #########
        self.chartRanks[94] = ['c_1001_discos_que_debes_escuchar_antes_de_forear', 'c_100_most_mind_bending_life_changing_brain_expanding_records_of_all_time', 'c_2010_2019', 'c_500_Death_Metal_Recordings_You_Must_Hear_Before_You_Die', 'c_70s_80s_Jamaican_Dub', 'c_An_Ode_to_the_Death_of_the_80s']
        self.chartRanks[95] = ['c_An_Outsider_Guitde_to_Russian_Dance_Music', 'c_Best_Female_Voices', 'c_Best_of_Jazz_Improv_1970s_2010s_', 'c_Best_of_the_1970s', 'c_Best_of_the_1980s', 'c_Billboard_charts_1990s']
        self.chartRanks[96] = ['c_Black_White', 'c_Blow_Up_Magazines_600_essential_albums', 'c_Brazil', 'c_CITY_LIFE_ESCAPE', 'c_COUNTRY_STRONG', 'c_Canada_in_the_1980s']
        self.chartRanks[97] = ['c_Country_Rock_Colossus', 'c_DJ_Mixes', 'c_Dark_Ambient_Essentials', 'c_EMI_Nigeria_45s', 'c_Eastern_Europe_DIY_Tapes_1978_89', 'c_Emo_Rap']
        self.chartRanks[98] = ['c_Futuristic_music', 'c_Gentle_Dads', 'c_Great_obscure_lesser_known_albums', 'c_Greatest_Rappers_of_All_Time', 'c_Guide_To_Indie_Twee_Pop', 'c_Hazy_Memory_Nocturnal_Version']
        self.chartRanks[99] = ['c_Helio_Reviews_the_Singles', 'c_Hip_Hop_in_the_2010s_An_Essential_Chronology', 'c_J_Pop_and_K_Pop_Party', 'c_Jazz_Core_Collection', 'c_Jazz_and_other_Jazz_styles_from_Africa', 'c_Jazzcore_Punk_Jazz_Brutal_Jazz_etc_']
        self.chartRanks[100] = ['c_Lets_listen_to_Canadian_progressive_music', 'c_Most_commented_on_comment_boxes', 'c_Music_to_commit_suicide_to', 'c_My_100_Favourite_Singles_of_the_1990s', 'c_My_75_Favourite_Singles_of_the_2000s', 'c_My_Best_Hip_Hop_Producers_Of_All_Time']
        self.chartRanks[101] = ['c_My_Top_2500_Bands_of_all_time', 'c_My_number_1_hits', 'c_My_top_50_Britpop_songs_', 'c_Nightwalking_Music', 'c_Obscurities', 'c_POPTIMISM_Boy_Bands_Girl_Groups_Pop_Rock_Electropop_90s_onward_Dance_Pop_Latin_Pop_K_Pop_J_Pop_Teen_Pop']
        self.chartRanks[102] = ['c_Prolific_Outsiders_and_Weirdos', 'c_Psychedelic_60s', 'c_Recommended_Dance_Singles_EP', 'c_Releases_with_Armenian_script', 'c_Releases_with_Devanagari_script', 'c_Releases_with_Hangul_script']
        self.chartRanks[103] = ['c_Russian_Post_Punk', 'c_Scandinavian_Rock', 'c_Summer_song_playlist', 'c_TOP_100_SONGWRITERS', 'c_Tapeaholics_Anonymous', 'c_Thailand_Luk_Thung_Molam']
        self.chartRanks[104] = ['c_The_Top_125_Singles_of_1997', 'c_The_Wires_150_Sonic_Essentials_and_Aural_Obscurities', 'c_The_best_songs_by_all_female_rock_bands', 'c_The_most_melancholic_albums_ever', 'c_Top_1000_tracks_of_all_time', 'c_Top_1200_Singles_of_the_90s']
        self.chartRanks[105] = ['c_Top_50_albums_by_nordic_scandinavian_artists', 'c_Trap_releases_I_like', 'c_UK_Singles_Chart_Every_artist_that_reached_1', 'c_Ultimate_NonPop', 'c_Upbeat_2000s_Pop', 'c_Upbeat_2020s_Pop']
        self.chartRanks[106] = ['c_Upbeat_70s_Pop', 'c_Upbeat_80s_Pop', 'c_Upbeat_90s_Pop', 'c_Voice_is_an_instrument_Extended_vocal_vocabulary', 'c_WOEBOTs_The_100_Greatest_Records_Ever', 'c_Who_ruled_the_80s_The_200_biggest_artists_of_the_decade_in_the_USA_']
        self.chartRanks[107] = ['c_all_the_k_Pop', 'c_r_b_for_the_sleepless_deep_r_b_', 'c_rym', 'c_s_a_d', 'c_songs_that_youtube_are_manipulating_me_into_listening_to', 'c_terrorize_the_jam_like_troops_in_Pakistan']
        self.chartRanks[108] = ['c_thats_the_way_love_is_200_deep_house_selection', 'c_top_500_songs', 'c_underground_new_wave_from_USA', 'c_untitled_folder']
        ######### Releases - Best #########
        self.chartRanks[109] = ['c_Top_Releases_of_the_1950s', 'c_Top_Releases_of_the_1960s', 'c_Top_Releases_of_the_1970s', 'c_Top_Releases_of_the_1980s', 'c_Top_Releases_of_the_1990s', 'c_Top_Releases_of_the_2000s']
        self.chartRanks[110] = ['c_Top_Releases_of_the_2010s']
        ######### Releases - Worst #########
        self.chartRanks[111] = ['c_Bottom_Releases_of_the_1950s', 'c_Bottom_Releases_of_the_1960s', 'c_Bottom_Releases_of_the_1970s', 'c_Bottom_Releases_of_the_1980s', 'c_Bottom_Releases_of_the_1990s', 'c_Bottom_Releases_of_the_2000s']
        self.chartRanks[112] = ['c_Bottom_Releases_of_the_2010s']
