...
class latinAmericaCharts:
    def __init__(self):
        ...
        self.chartRanks = {}
        self.chartRanks[0] = ['latin']
        
        self.countries = ["latin"]
...
class latinAmericaData:
    def __init__(self, debug=False, minYear=1, maxYear=9999):
        ...
        self.basename  = "latinamerica"
        #self.baseDir  = "/Volumes/Piggy/Charts/{0}".format(self.
        self.files     = []
        self.chartData = None
        self.udCharts  = latinAmericaCharts()
    ...
    def findFiles(self):
        savedir = join(self.basedir, "data", "latinamerica", "categories")
    ...
    def saveChartData(self):
        for category,categoryData in self.chartData.items():
            saveDir = join(self.basedir, "data", "latinamerica", "results")
            if not isDir(saveDir):
                raise ValueError("Could not find directory: {0}".format(savedir))
