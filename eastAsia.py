...
class eastAsiaCharts:
    def __init__(self):
        ...
        self.chartRanks = {}
        self.chartRanks[0] = ['japan']
        self.chartRanks[1] = ['korea']
        self.chartRanks[2] = ['china']
        
        self.countries = ["japan", "korea", "china"]
...
class eastAsiaData:
    def __init__(self, debug=False, minYear=1, maxYear=9999):
        ...
        self.basename  = "eastasia"
        #self.baseDir  = "/Volumes/Piggy/Charts/{0}".format(self.
        self.files     = []
        self.chartData = None
        self.udCharts  = eastAsiaCharts()
    ...
    def findFiles(self):
        savedir = join(self.basedir, "data", "eastasia", "categories")
    ...
    def saveChartData(self):
        for category,categoryData in self.chartData.items():
            saveDir = join(self.basedir, "data", "eastasia", "results")
            if not isDir(saveDir):
                raise ValueError("Could not find directory: {0}".format(savedir))
